...
public class DialogoAgrupaciones extends JDialog implements ActionListener{
	...
	public DialogoAgrupaciones(JFrame ventana, Agrupaciones controladorAgrupaciones) {
		super(ventana,"Nueva Agrupaci�n", true);
	...
	private Component crearPanelNombre() {
		...
		panel.add(new JLabel("Nombre de la agrupaci�n: "));
		panel.add(tnombre);
	...
	public void transferirAGrupo(int[] seleccionados) {
		...
		if(repetido)JOptionPane.showMessageDialog(this, "Hay uno o m�s dispositivos repetidos","Error",JOptionPane.ERROR_MESSAGE);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("ok")) {
			...
			JOptionPane.showMessageDialog(this, "La lista de la agrupaci�n est� vac�a","Error",JOptionPane.ERROR_MESSAGE);
	...
	private void verificarLista() throws ListaVaciaException{
		if(this.getListaAgrupacion().isEmpty()) throw new ListaVaciaException("La lista de la agrupaci�n est� vac�a");
	}
		...
		mapaAgrupacion.entrySet().forEach(entry->{
			if(nombreVerificar.toLowerCase().equals(entry.getKey().toLowerCase())) {
					try {
						...
						JOptionPane.showMessageDialog(this, "Ya existe una agrupaci�n con ese mismo nombre","Error",JOptionPane.ERROR_MESSAGE);
						errorIgual=true;
					}
				} 
		});
